...
**Task done checklist — all boxes must be checked before advancing to the next task:**
...
**Only advance to the next task when ALL boxes are checked.** If any test fails → fix
